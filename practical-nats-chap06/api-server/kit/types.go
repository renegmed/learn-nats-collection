...
// Location is represents the latitiude and longitude pair
...
type DriverAgentResponse struct {
	// ID is the identifier of the driver the will accept
	// the request
	ID string `json:"driver_id,omitempty"`

	// Error is included in case there was an error handling
	// the request
